    ...
    <div className={styles.request}>
      ...
      <div className={styles.body}>
        ...
        <p className={styles.upload}>
          <label className={styles.topic}>
            <label className={styles.title}>อัพโหลดไฟล์รูปเล่มโครงงาน</label>
          </label>
        </p>
        <p>
          <input
        ...
        <p>
          <button id="preview" className={styles.mini} onClick={priview}>
            preview
          </button>
        </p>
        <p>
          <button onClick={confirmOn}>ส่ง</button>
        </p>
      </div>
      <div id="confirmModal" className={styles.modal}>
        <div className={styles.modal_content}>
          ...
          <div className={styles.modal_body}>
            ...
            <button onClick={sendFile}>ยืนยัน</button>
          </div>
        </div>
      </div>
    </div>
